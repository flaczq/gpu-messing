...
namespace Constants {
    namespace Color {
        ...
        inline constexpr glm::vec3 LIGHGTGREEN  { 0.3f , 0.6f , 0.3f  };
        inline constexpr glm::vec3 NATGREEN     { 0.35f, 0.55f, 0.20f };
        ...
        inline constexpr glm::vec3 PURPLE       { 0.5f , 0.0f , 0.5f  };
        inline constexpr glm::vec3 PINK         { 1.0f , 0.75f, 0.8f  };
        inline constexpr glm::vec3 BROWN        { 0.6f , 0.3f , 0.0f  };
        inline constexpr glm::vec3 LIME         { 0.75f, 1.0f , 0.0f  };
        inline constexpr glm::vec3 TEAL         { 0.0f , 0.5f , 0.5f  };
